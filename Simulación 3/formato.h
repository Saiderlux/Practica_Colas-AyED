...
void Encolar(cola * c, int x, int y);	//Encolar : Recibe una cola y el numero de fila de esa cola e imprime la cola con el nuevo elemento
void Desencolar(cola * c, int x, int y);			//Desencolar (Dequeue): Recibe una cola y el numero de fila de esa cola: recorre la fila para eliminar el primer elemento
void limpiarCola(int x, int y);	//Recibe el indice de la cola a eliminar: Limpia en la cola mencionada
